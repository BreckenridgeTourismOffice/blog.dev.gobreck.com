...
if ( is_admin() ){
  ...
  $cb_cat_meta->addSelect($prefix.'cat_style_field_id',array('style-a'=>'Blog Style A','style-b'=>'Blog Style B','style-c'=>'Blog Style C','style-d'=>'Blog Style D','style-e'=>'Blog Style E','style-f'=>'Blog Style F (A+D)'),array('name'=> __('Blog Style ','tax-meta'), 'std'=> array('style-a')));
  ...
  $cb_tag_meta->addSelect($prefix.'cat_style_field_id',array('style-a'=>'Blog Style A','style-b'=>'Blog Style B','style-c'=>'Blog Style C','style-d'=>'Blog Style D','style-e'=>'Blog Style E','style-f'=>'Blog Style F (A+D)'),array('name'=> __('Blog Style ','tax-meta'), 'std'=> array('style-a')));
